		...
		<div class="header-main-area sticky">
			<div class="container">
				<div class="row align-items-center position-relative">
					...
					<div class="col-lg-2">
						<div class="logo">
							<a href="index"> <img src="assets/img/logo/logo.png"
								alt="Brand Logo">
							</a>
						</div>
					</div>
									...
									<ul>
										...
										<li class="position-static"><a href="#">pages <i
											...
											<ul class="megamenu dropdown">
												...
												<li class="megamenu-banners d-none d-lg-block"><a
													href="product-details"> <img
														src="assets/img/banner/img1-static-menu.jpg" alt="">
												</a></li>
												<li class="megamenu-banners d-none d-lg-block"><a
													href="product-details"> <img
														src="assets/img/banner/img2-static-menu.jpg" alt="">
												</a></li>
											</ul></li>
										<li><a href="shop">shop <i class="fa fa-angle-down"></i></a>
											<ul class="dropdown">
												<li><a href="#">shop grid layout <i
													...
													<ul class="dropdown">
														<li><a href="shop-grid-full-4-col">shop grid full
																4 col</a></li>
													</ul></li>
												<li><a href="product">products details <i
						...
						<div
							...
							<div class="header-configure-area">
								<ul class="nav justify-content-end">
									<li class="user-hover"><a href="#"> <img style="max-height: 30px;max-width: 30px" alt="" src="${user.userImage}"/> <i 
											class="pe-7s-user"></i>
									</a>
										<ul class="dropdown-list">
								...
								<ul class="dropdown">
									<li class="menu-item-has-children"><a href="#">shop
										...
										<ul class="dropdown">
											...
											<li><a href="shop-grid-full-4-col.jsp">shop grid
													full 4 col</a></li>
										</ul></li>
									<li><a href="shop-list-full-width">shop list layout</a></li>
									<li><a href="product">products details</a></li>
								</ul></li>
							...
							<div class="dropdown mobile-top-dropdown">
								...
								<div class="dropdown-menu" aria-labelledby="myaccount">
									<a class="dropdown-item" href="account">my account</a> <a
										class="dropdown-item" href="login-register"> login</a> <a
										class="dropdown-item" href="login-register">register</a>
								</div>
							</div>
						</li>
					</ul>
