			...
			<form id="form_role_add_edit">
				<div class="modal-body">
					<div class="form-group row">
						...
						<div class="col-sm-7">
							<input type="text"
								class="form-control validate[required,ajax[ajaxUserName]]"
					...
					<div class="form-group row">
						...
						<div class="col-sm-7">
							<textarea class="form-control " name="userCode" id="userCode"></textarea>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-sm-2 col-form-label">用户手机</label>
						<div class="col-sm-7">
							<textarea class="form-control " name="userPhone" id="userPhone"></textarea>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-sm-2 col-form-label">冻结状态</label>
						<div class="col-sm-7">
							<select class="form-control " name="userLock" id="userLock">
								<option value="1">无冻结</option>
