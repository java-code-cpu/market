                        ...
                        <div class="breadcrumb-wrap">
                            <nav aria-label="breadcrumb">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">shop 4 column</li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="shop-product-wrap grid-view row mbn-30">
                                    ...
                                    <div class="product-item">
                                        <figure class="product-thumb">
                                            ...
                                            <div class="button-group">
                                                <a href="wishlist.jsp" data-toggle="tooltip" data-placement="left" title="Add to wishlist"><i class="pe-7s-like"></i></a>
                                                <a href="" data-toggle="tooltip" data-placement="left" title="Add to Compare"><i class="pe-7s-refresh-2"></i></a>
                                        ...
                                        <div class="product-caption text-center">
                                            <div class="product-identity">
                                                <p class="manufacturer-name"><a href="product-details.jsp">Platinum</a></p>
                                            </div>
                                            ...
                                            <h6 class="product-name">
                                                <a href="product-details.jsp">Perfect Diamond Jewelry</a>
                                            </h6>
                                            <div class="price-box">
                                    ...
                                    <div class="product-list-item">
                                        ...
                                        <div class="product-content-list">
                                            <div class="manufacturer-name">
                                                <a href="product-details.jsp">Platinum</a>
                                            </div>
                                            <ul class="color-categories">
                                                <li>
                                                    <a class="c-lightblue" href="#" title="LightSteelblue"></a>
                                            ...
                                            <h5 class="product-name"><a href="product-details.jsp">Perfect Diamond Jewelry</a></h5>
                                            <div class="price-box">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    ...
                                    <div class="product-item">
                                        ...
                                        <div class="product-caption text-center">
                                            <div class="product-identity">
                                                <p class="manufacturer-name"><a href="product-details.jsp">Quickiin</a></p>
                                            </div>
                                            <ul class="color-categories">
                                                <li>
                                                    <a class="c-lightblue" href="#" title="LightSteelblue"></a>
                                            ...
                                            <h6 class="product-name">
                                                <a href="product-details.jsp">Handmade Golden Necklace</a>
                                            </h6>
                                            <div class="price-box">
                                                <span class="price-regular">$60.00</span>
                                                <span class="price-old"><del>$70.00</del></span>
                                    ...
                                    <div class="product-list-item">
                                        ...
                                        <div class="product-content-list">
                                            <div class="manufacturer-name">
                                                <a href="product-details.jsp">Diamond</a>
                                            </div>
                                            <ul class="color-categories">
                                                <li>
                                                    <a class="c-lightblue" href="#" title="LightSteelblue"></a>
                                            ...
                                            <h5 class="product-name"><a href="product-details.jsp">Handmade Golden Necklace</a></h5>
                                            <div class="price-box">
                                                <span class="price-regular">$50.00</span>
                                                <span class="price-old"><del>$29.99</del></span>
                                            </div>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    ...
                                    <div class="product-item">
                                        ...
                                        <div class="product-caption text-center">
                                            ...
                                            <h6 class="product-name">
                                                <a href="product-details.jsp">Diamond Exclusive Ornament</a>
                                            </h6>
                                            <div class="price-box">
                                                <span class="price-regular">$60.00</span>
                                                <span class="price-old"><del>$70.00</del></span>
                                    ...
                                    <div class="product-list-item">
                                        ...
                                        <div class="product-content-list">
                                            <div class="manufacturer-name">
                                                <a href="product-details.jsp">Quickiin</a>
                                            </div>
                                            <ul class="color-categories">
                                                <li>
                                                    <a class="c-lightblue" href="#" title="LightSteelblue"></a>
                                            ...
                                            <h5 class="product-name"><a href="product-details.jsp">Diamond Exclusive Ornament</a></h5>
                                            <div class="price-box">
                                                <span class="price-regular">$50.00</span>
                                                <span class="price-old"><del>$29.99</del></span>
                                            </div>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    ...
                                    <div class="product-item">
                                        ...
                                        <div class="product-caption text-center">
                                            <div class="product-identity">
                                                <p class="manufacturer-name"><a href="product-details.jsp">BDevs</a></p>
                                            </div>
                                            <ul class="color-categories">
                                                <li>
                                                    <a class="c-lightblue" href="#" title="LightSteelblue"></a>
                                    ...
                                    <div class="product-list-item">
                                        ...
                                        <div class="product-content-list">
                                            <div class="manufacturer-name">
                                                <a href="product-details.jsp">BDevs</a>
                                            </div>
                                            <ul class="color-categories">
                                                <li>
                                                    <a class="c-lightblue" href="#" title="LightSteelblue"></a>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    ...
                                    <div class="product-item">
                                        ...
                                        <div class="product-caption text-center">
                                            <div class="product-identity">
                                                <p class="manufacturer-name"><a href="product-details.jsp">Hastech</a></p>
                                            </div>
                                            <ul class="color-categories">
                                                <li>
                                                    <a class="c-lightblue" href="#" title="LightSteelblue"></a>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    ...
                                    <div class="product-item">
                                        ...
                                        <div class="product-caption text-center">
                                            <div class="product-identity">
                                                <p class="manufacturer-name"><a href="product-details.jsp">Gold</a></p>
                                            </div>
                                            <ul class="color-categories">
                                                <li>
                                                    <a class="c-lightblue" href="#" title="LightSteelblue"></a>
                                    ...
                                    <div class="product-list-item">
                                        ...
                                        <div class="product-content-list">
                                            <div class="manufacturer-name">
                                                <a href="product-details.jsp">Gold</a>
                                            </div>
                                            <ul class="color-categories">
                                                <li>
                                                    <a class="c-lightblue" href="#" title="LightSteelblue"></a>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    ...
                                    <div class="product-item">
                                        ...
                                        <div class="product-caption text-center">
                                            <div class="product-identity">
                                                <p class="manufacturer-name"><a href="product-details.jsp">Silver</a></p>
                                            </div>
                                            <ul class="color-categories">
                                                <li>
                                                    <a class="c-lightblue" href="#" title="LightSteelblue"></a>
                                    ...
                                    <div class="product-list-item">
                                        ...
                                        <div class="product-content-list">
                                            <div class="manufacturer-name">
                                                <a href="product-details.jsp">Silver</a>
                                            </div>
                                            <ul class="color-categories">
                                                <li>
                                                    <a class="c-lightblue" href="#" title="LightSteelblue"></a>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    ...
                                    <div class="product-item">
                                        ...
                                        <div class="product-caption text-center">
                                            <div class="product-identity">
                                                <p class="manufacturer-name"><a href="product-details.jsp">Maya</a></p>
                                            </div>
                                            <ul class="color-categories">
                                                <li>
                                                    <a class="c-lightblue" href="#" title="LightSteelblue"></a>
                                    ...
                                    <div class="product-list-item">
                                        ...
                                        <div class="product-content-list">
                                            <div class="manufacturer-name">
                                                <a href="product-details.jsp">Maya</a>
                                            </div>
                                            <ul class="color-categories">
                                                <li>
                                                    <a class="c-lightblue" href="#" title="LightSteelblue"></a>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    ...
                                    <div class="product-item">
                                        ...
                                        <div class="product-caption text-center">
                                            <div class="product-identity">
                                                <p class="manufacturer-name"><a href="product-details.jsp">Jem</a></p>
                                            </div>
                                            <ul class="color-categories">
                                                <li>
                                                    <a class="c-lightblue" href="#" title="LightSteelblue"></a>
                                    ...
                                    <div class="product-list-item">
                                        ...
                                        <div class="product-content-list">
                                            <div class="manufacturer-name">
                                                <a href="product-details.jsp">Jem</a>
                                            </div>
                                            <ul class="color-categories">
                                                <li>
                                                    <a class="c-lightblue" href="#" title="LightSteelblue"></a>
                            ...
                            <li class="minicart-item">
                                ...
                                <div class="minicart-content">
                                    <h3 class="product-name">
                                        <a href="product-details.jsp">Dozen White Botanical Linen Dinner Napkins</a>
                                    </h3>
                                    <p>
